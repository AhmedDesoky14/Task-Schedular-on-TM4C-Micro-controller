 ...
 * File Name: Dio.h
 *
 * Description: Header file for TM4C123GH6PM Micro-controller - Dio Driver
 *
 * Author: Ahmed Desoky
 ************************************************************************************************************/
 ...
 * The API service shall return immediately without any further action,
   * beside reporting this development error.*/ /*function got null pointer other than the config pointer for example get version info function*/
 ...
 * exists in newer AUTOSAR Version
 */
...
typedef struct Dio_ConfigType
{
	...
	Dio_PortType Ports[DIO_CONFIGURED_PORTS];	/* Holds Port number of configured port */
#endif
} Dio_ConfigType;
...
void Dio_WriteChannel(Dio_ChannelType ChannelId, Dio_LevelType Value);
